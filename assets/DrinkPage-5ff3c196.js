import{s as t,t as h,u as j,c as m,r as g,a1 as I,y as k,a2 as P,j as e,a3 as S,a0 as y,Q as u,a4 as z,a5 as F,i as R,a6 as B,a7 as W,a8 as L,C}from"./index-28ed5fc1.js";import{S as v}from"./stub-9e309606.js";import{P as A}from"./PageTitle-0fb5dd3e.js";const E=t.p`
...
`,ie=({ingredients:i})=>{const s=m();g.useEffect(()=>{s(R())},[s]);const{drinks:n}=j(),r=n[0].ingredients;return e.jsx(e.Fragment,{children:r.length>0&&e.jsxs(e.Fragment,{children:[" ",e.jsx(Z,{children:"Ingredients"}),e.jsx(ee,{children:i.map(d=>{const o=r.find(c=>c._id===d.ingredientId),a={ingredientThumb:"","thumb-medium":"","thumb-small":""};return o&&(a.ingredientThumb=o.ingredientThumb,a["thumb-medium"]=o["thumb-medium"],a["thumb-small"]=o["thumb-small"]),e.jsx("li",{children:e.jsx(Y,{title:d.title,measure:d.measure,quantity:d.quantity,images:a})},d.ingredientId)})})]})})},w="/fs-77-react-node-svoits/assets/recipe-default-mobile-024f5e03.jpg",te="/fs-77-react-node-svoits/assets/recipe-default-mobile@2x-087cb7d6.jpg",ne="/fs-77-react-node-svoits/assets/recipe-default-tablet-d31df6dd.jpg",re="/fs-77-react-node-svoits/assets/recipe-default-tablet@2x-026033bc.jpg",se="/fs-77-react-node-svoits/assets/recipe-default-desktop-0b296897.jpg",de="/fs-77-react-node-svoits/assets/recipe-default-desktop@2x-1473f0df.jpg",oe=t.h2`
  color: ${({theme:i})=>i.mainText};
  font-size: 28px;
  font-weight: 600;
  line-height: 1.14;
...
`,xe=({instructions:i})=>e.jsxs(e.Fragment,{children:[e.jsx(oe,{children:"Recipe Preparation"}),e.jsxs(ce,{children:[e.jsx(ae,{children:i}),e.jsxs("picture",{children:[e.jsx("source",{media:"(min-width: 1440px)",srcSet:`${se} 1x, ${de} 2x`}),e.jsx("source",{media:"(min-width: 768px)",srcSet:`${ne} 1x, ${re} 2x`}),e.jsx("source",{media:"(min-width: 375px)",srcSet:`${w} 1x, ${te} 2x`}),e.jsx(pe,{src:w,alt:"drinks photo"})]})]})]}),he=t.section`
  padding-top: 80px;
  padding-bottom: 80px;
...
`;function ue(){const i=m(),{drinkId:s}=B(),n=k(r=>W(r,s));return g.useEffect(()=>{i(L(s))},[i,s]),e.jsx(he,{children:e.jsx(C,{children:n&&e.jsxs(e.Fragment,{children:[e.jsx(Q,{id:n._id,name:n.drink,glass:n.glass,alcoholic:n.alcoholic,description:n.description,imgPath:n.drinkThumb}),e.jsx(ie,{ingredients:n.ingredients}),e.jsx(xe,{instructions:n.instructions})]})})})}export{ue as default};
